...
//Theo moi 1 dong du lieu vao table LoaiSP
    ...
    public void InsertData(String ml, String tl,String sl) throws SQLException {
        String sql = "INSERT INTO LoaiSanpham values('" + ml + "',N'" + tl + "','" + sl + "')";
        cn.UpdateData(sql);
    }
//Dieu chinh 1 dong du lieu vao table LoaiSP

    public void EditData(String ml, String tl,String sl) throws SQLException {
        String sql = "Update LoaiSanpham set TenLoai=N'" + tl +"',Chongoi = '"+sl
                + "' where IDLoai='" + ml + "'";
