...
//Lay chi so dong cuoi cung
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/3d-printer.png"))); // NOI18N

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/3d-printer (1).png"))); // NOI18N

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/3d-printer (3).png"))); // NOI18N
    ...
    private void luuspActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_luuspActionPerformed
        ...
        //            {
            ...
            try {
                ...
                ShowData1(); //Do lai du lieu vao Table Model
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "Cap nhat that bai",
                    "Thong bao", 1);
